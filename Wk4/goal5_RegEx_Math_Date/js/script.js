...
*/
	...
	var clean = str.replace(/(\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,3})/g, "XXX@XXX.com");
	console.log(clean);
...
*/
    ...
    ****************************************************************************/
	...
	console.log("random int: ", Math.floor(Math.random() * 10000 + 100));

	var num = (Math.random() * 100 + 10);
	console.log("random num: ", num);
	console.log("random rnd: ", Math.round(num));
